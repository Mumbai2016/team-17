...
$meetings = $m->GetCompleteMeetings(2);
...
$osmeetings = $mmp->getOverScheduledMeeting();
...
<head>
    ...
    <title>Administrator Page Page</title>
    ...
    <div class="menu-wrap">
		<nav class="menu">
			...
			<div style="line-height:0.0001em;margin-bottom:15px;">
				...
				<a href="#" class="logo page-scroll waves-effect">get name</a>
			</div>
				<a href="dash.php" class="page-scroll waves-effect"><i class="fa fa-fw fa-user"></i><span>Mapping</span></a>
				<a href="#" class="page-scroll waves-effect"><i class="fa fa-bullhorn"></i><span>Meeting</span></a>
                    ...
                    <div class="testimonial-section waves-effect">
                        ...
                        foreach($osmeetings as $meeting) { ?>
                            ...
                            <div class="latest-post waves-effect">
                                ...
                                <a  href="sendsms.php?pair_id=<?php echo $meeting['pair_id']?>" >Send SMS</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" action="login.php" method="post" name="form">
		     <div class="form-group">
              <label for="agenda"><span>Agenda:</span></label>
